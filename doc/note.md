-   @thk 现在的逻辑比较简单, 都是从上往下

    -   如果在行为中要触发

-   @ques 一个地方保存数据, 但是我不知道这些数据能做什么
    -   这样符合逻辑思维吗....
    -   最好的是我同时知道他有数据以及他能做什么
    -   最好这两个还是分离的 这样更清晰...
    -   这就是 rust 的逻辑...
...
-   @ques 行为就会可以操作所有的 model 了

    -   他是如何知道自己有多少的 model 呢, 如何获取特定的 model 呢
    -   自己创建的 自己肯定是知道有多的...

-   @ques cmdBehave 保存有所有的的 cmd, 这样 cmdGroup 还有什么意义吗

-   @opt CmdManagerBehave 其实没有必要存在了 直接访问 cmdGroup 就可以了
